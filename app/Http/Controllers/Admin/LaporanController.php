...
class LaporanController extends Controller
{
    ...
    { 
        ...
        $items = DB::select("
            SELECT users.nik,users.rekening,users.nama,jabatan.nama as nama_jabatan, jabatan.gaji_pokok,jabatan.transportasi,jabatan.uang_makan,absensi.alpha,absensi.izin
            FROM users
