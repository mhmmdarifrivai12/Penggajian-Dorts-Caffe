...
class GajiController extends Controller
{
    public function index(Request $request)
    {
        ...
        if($bulan === '') {
            ...
            $items = DB::select(" 
                SELECT users.nik,users.rekening,users.nama,users.jenis_kelamin,jabatan.nama as nama_jabatan,jabatan.gaji_pokok,jabatan.transportasi,jabatan.uang_makan,absensi.alpha,absensi.izin
